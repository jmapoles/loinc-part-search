...
# postgres
access_loinc = conn.AccessLOINC( "postgres" , "localhost", "postgres", "JANN1qwe1!", "loinc_demo" )

# mysql
# access_loinc = conn.AccessLOINC( "postgres" , "localhost", "root", "JANN1qwe1!", "loinc_demo" )
